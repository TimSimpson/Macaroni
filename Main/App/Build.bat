...
REM macaroni --messagesPath=Source\main\resources\Messages.txt --libraryRepoPath=..\Libraries  -b  --showPaths -o "link=static --toolset=msvc-12.0 -j8" --printTimes --verbose
echo WHY
bash build.sh %*
