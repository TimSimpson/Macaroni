...
macaroni --messagesPath=Source\main\resources\Messages.txt --libraryRepoPath=..\Libraries --generatorPath=..\Generators -b  --showPaths -o "link=static --toolset=msvc-12.0"
