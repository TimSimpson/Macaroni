...
DependencyList = {
    ...
    addDependenciesForType = function(self, type, traveller, asLight)
        ...
        if (type.Node.Member == nil) then
            error("addDependenciesForType was passed " .. type.Node.FullName .. ", which is a hollow node..", 2);
        end
            ...
            for i = 1, #type.TypeArguments do
                ...
                for j = 1, #typeArg do
                    ...
                    check(typeArgType.Node ~= nil,
                        "While adding dependencies for type " ..
                        type.Node.FullName .. ", found that it has " ..
                        "type argument with a node which is nil.");
                    check(typeArgType.Node.Member ~= nil,
                          "While adding dependencies for type " ..
                          type.Node.FullName .. ", found that it has " ..
                          "type argument with hollow node " ..
                          typeArgType.Node.FullName .. ".");
