...
bool  Builder::CopyCppFiles(path  exportCppDir)
{
...
void  Builder::Execute(bool  generate, bool  saveCppSource, bool  compile, bool  install)
{
...
bool  Builder::Install()
{
        ...
        // Export C++ source
        path exportCppLocal(manifest.GetCppSourceOutput());
        path exportCppInstall = installPath / "Cpp";
        boost::filesystem::create_directories(exportCppInstall);
        CopyCppFiles(exportCppInstall);
...
bool  Builder::SaveCppSource()
{
        ...
        std::stringstream ss;
        ss << "Saving generated C++ sourc code to " <<
