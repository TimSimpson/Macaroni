...
public:
	...
	static VariablePtr Create(NodePtr home, const VariableTypeInfo & typeInfo, Model::ReasonPtr reason);
...
private:
	...
	Variable(Node * home, Model::ReasonPtr reason, const VariableTypeInfo & typeInfo);
