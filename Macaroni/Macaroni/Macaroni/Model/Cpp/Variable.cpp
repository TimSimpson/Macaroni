...
Variable::Variable(Node * parent, ReasonPtr reason, const VariableTypeInfo & info)
...
VariablePtr Variable::Create(NodePtr host, const VariableTypeInfo & info, ReasonPtr reason)
{
	if (!host->GetMember())
	{
