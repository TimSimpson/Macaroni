...
: compile(false), config(""), console(console), debugMode(false), endPrompt(false), generate(false), inputPath(""), install(false), luaTestsPath(""), manifestPath(""), outputPath("")
{
...
void  CmdLine::runManifest()
{
        ...
        builder.Execute(generate, compile, install);
