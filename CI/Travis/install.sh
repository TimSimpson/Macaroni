...
if [ ! -d ~/OldMacaroniBuild ]; then
    ...
    wget http://border-town.com/macaroni/downloads/macaroni-0.4.3-pureCpp.zip
    unzip macaroni-0.4.3-pureCpp.zip
...
if [ ! -d ~/OldMacaroni ]; then
    ...
    mkdir -p ~/OldMacaroni
    pushd ~/OldMacaroni
    wget http://border-town.com/macaroni/downloads/macaroni-0.4.3-windows.zip
    unzip macaroni-0.4.3-windows.zip
    rm macaroni.exe
